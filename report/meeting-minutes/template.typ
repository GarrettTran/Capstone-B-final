...
#let meeting(m) = {
  ...
  table(columns: (25mm, 1fr), inset: 6pt, stroke: 0.5pt + rgb("777777"), fill: rgb("f6f7f9"),
  ...
  table(columns: (16mm, 1fr), inset: 6pt, stroke: 0.5pt + rgb("777777"),
  ...
  v(4pt)
  table(columns: (12mm, 1fr, 27mm, 23mm), inset: 5pt, stroke: 0.5pt + rgb("777777"),
